    ...
    <table class="table-bordered">
        ...
        <tbody>
            <tr>
                ...
                <td style="text-align: right;">{{ number_format($sp2d->spm->spp->pengajuan_up->nilai, 2, ',', '.') }}
                </td>
                <td>{{ $sp2d->spm->spp->pengajuan_up->uraian }}</td>
                <td style="text-align: right;">{{ number_format($sp2d->spm->spp->pengajuan_up->nilai, 2, ',', '.') }}
                </td>
                <td style="text-align: right;">{{ number_format($sp2d->spm->spp->pengajuan_up->nilai, 2, ',', '.') }}
                </td>
                <td style="text-align: right;">
                    {{ number_format($sp2d->spm->spp->pengajuan_up->nilai - $sp2d->spm->spp->pengajuan_up->nilai, 2, ',', '.') }}
                </td>
            </tr>
        </tbody>
        <tfoot>
            ...
            <tr>
                <td colspan="3">
                    <b>Terbilang:</b> <i>{{ Str::title(Terbilang::make($sp2d->spm->spp->pengajuan_up->nilai)) }}
                        Rupiah</i>
                </td>
            </tr>
        </tfoot>
