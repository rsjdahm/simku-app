...
<body>
    ...
    <div style="margin-left: 65%;">
        ...
        Kepada
        <br />
        <div style="text-indent: -0.7cm;">Yth. Pengguna Anggaran/Kuasa Pengguna Anggaran</div>
    ...
    <center>
        Nomor:
        {{ $spp->nomor }}/SPP-GU/RSJDAHM/BLUD/{{ Terbilang::roman(Carbon\Carbon::parse($spp->tanggal)->month) }}/{{ Carbon\Carbon::parse($spp->tanggal)->year }}
    </center>
    <br />
    ...
    <table class="table-bordered">
        ...
        <tbody>
            <tr>
                ...
                <td>Bersama ini terlampir Surat Permintaan Pembayaran Ganti Uang Persediaan (SPP-GU) BLUD Rumah Sakit
                    Jiwa
                    Daerah Atma Husada Mahakam Tahun Anggaran <strong>Rp.
                        {{ number_format(
                            $spp->spj_gu->bukti_spj_gu->sum(function ($bukti_spj_gu) {
                                return $bukti_spj_gu->bukti_gu->sum('nilai');
                            }),
                            2,
                            ',',
                            '.',
    ...
    <div style="font-size: 8pt;">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center; vertical-align: middle;">
                                ...
                                <h2 style="margin: 0; font-size: 11pt;">SURAT PERMINTAAN PEMBAYARAN UANG PERSEDIAAN
                                    ...
                                    BLUD </h2>
                                Nomor :
                                {{ $spp->nomor }}/SPP-GU/RSJDAHM/BLUD/{{ Terbilang::roman(Carbon\Carbon::parse($spp->tanggal)->month) }}/{{ Carbon\Carbon::parse($spp->tanggal)->year }}<br />
        ...
        <div>
            ...
            <br />
            {{ $spp->spj_gu->sub_unit_kerja->nama }}
            <br />
            di Tempat
        </div>
        ...
        <p style="text-align:
            ...
            ini kami mengajukan Surat Permintaan Pembayaran Ganti Uang Persediaan sebagai berikut:
        </p>
        <table>
            <tr>
                ...
                <td style="vertical-align: top;">
                    {{ $spp->spj_gu->sub_unit_kerja->unit_kerja->bidang->kode_lengkap }}
                    {{ $spp->spj_gu->sub_unit_kerja->unit_kerja->bidang->urusan->nama }}
                </td>
            </tr>
            <tr>
                <td style="vertical-align: top;">
                ...
                <td style="vertical-align: top;">
                    {{ $spp->spj_gu->sub_unit_kerja->kode_lengkap }}
                    {{ $spp->spj_gu->sub_unit_kerja->nama }}
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top;">
                    Rp {{ number_format($spp->spj_gu->nilai, 2, ',', '.') }}
                    <br />
                    (<i>{{ Str::title(Terbilang::make($spp->spj_gu->nilai)) }}
                        @if (fmod($spp->spj_gu->nilai, 1) != 0)
                            Koma {{ Str::title(Terbilang::make(fmod($spp->spj_gu->nilai, 1) * 100)) }}
                        @endif Rupiah
                    </i>)
                </td>
            </tr>
