...
<body>
    ...
    <table class="table-bordered">
        ...
        <tbody>
            <tr>
                ...
                <td>Bersama ini terlampir Surat Permintaan Pembayaran Langsung (SPP-LS) BLUD Rumah Sakit Jiwa
    ...
    <div style="font-size: 8pt;">
                    ...
                    <table>
                        <tr>
                            ...
                            <td style="text-align: center; vertical-align: middle;">
                                ...
                                <h2 style="margin: 0; font-size: 11pt;">SURAT PERMINTAAN PEMBAYARAN LANGSUNG
                                    (SPP-LS)
                                    BLUD </h2>
                                Nomor :
        ...
        <p style="text-align:
            ...
            ini kami mengajukan Surat Permintaan Pembayaran Langsung sebagai berikut:
        </p>
        <table>
            <tr>
                ...
                <td style="vertical-align: top;">
                    {{ $spp->belanja_ls->belanja_rka_pd->rka_pd->sub_unit_kerja->unit_kerja->bidang->kode_lengkap }}
                    {{ $spp->belanja_ls->belanja_rka_pd->rka_pd->sub_unit_kerja->unit_kerja->bidang->urusan->nama }}
                </td>
            </tr>
            <tr>
                <td style="vertical-align: top;">
                ...
                <td style="vertical-align: top;">
                    {{ $spp->belanja_ls->belanja_rka_pd->rka_pd->sub_unit_kerja->kode_lengkap }}
                    {{ $spp->belanja_ls->belanja_rka_pd->rka_pd->sub_unit_kerja->nama }}
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="vertical-align: top;">
                    Rp {{ number_format($spp->belanja_ls->nilai, 2, ',', '.') }}
                    <br />
                    (<i>{{ Str::title(Terbilang::make($spp->belanja_ls->nilai)) }}
                        @if (fmod($spp->belanja_ls->nilai, 1) != 0)
                            Koma {{ Str::title(Terbilang::make(fmod($spp->belanja_ls->nilai, 1) * 100)) }}
